...
//          view.addSubview(myView)
        ...
        let imageView = UIImageView(frame: CGRect(x: 52, y: 347, width: 300, height: 200))
       ...
       // button.addTarget(self, action: #selector(fromThirdToFourth), for: .touchUpInside)
        view.addSubview(button)
        
        ///Setting Labels for frontview
        let label1 =  UILabel()
        label1.text="Set Targets,Stay Motivated"
        label1.textColor=UIColor(red: 1/255, green: 46/255, blue: 87/255,alpha: 1)
        label1.textAlignment = .center
        label1.font = UIFont.boldSystemFont(ofSize:28)
        ...
        subTitle.text = "Achieve faster recovery with\ngamification themes and daily\n targets"
